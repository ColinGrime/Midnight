...
public final class Tooltip {
    ...
    /**
     * Creates a TextComponent with hoverable text and a command to suggest when the text is clicked.
     *
     * @param message  the message to be displayed
     * @param tooltips the list of strings to be added as hoverable text
     ...
     */
    @Nonnull
    public static TextComponent create(@Nonnull String message, @Nonnull List<String> tooltips, @Nonnull String command) {
        TextComponent component = new TextComponent(message);
        component.setHoverEvent(new HoverEvent(HoverEvent.Action.SHOW_TEXT, new Text(String.join("\n", tooltips))));
     ...
     */
    @Nonnull
    public static ComponentMessage create(@Nonnull Player player, @Nonnull String message, @Nonnull List<String> tooltips, @Nonnull String command) {
        TextComponent component = new TextComponent(message);
        component.setHoverEvent(new HoverEvent(HoverEvent.Action.SHOW_TEXT, new Text(String.join("\n", tooltips))));
        component.setClickEvent(new ClickEvent(ClickEvent.Action.SUGGEST_COMMAND, command));
        return Placeholders.create(player).apply(component);
